  ...
  return (
    <div className="mx-auto max-w-5xl px-4 md:px-6 py-12 md:py-16 space-y-10">
      ...
      <div className="panel rounded-2xl p-6 border border-slate-800/70 space-y-3">
        <h3 className="text-lg font-semibold text-amber-200">Ključne aktivnosti</h3>
        <ul className="text-sm text-slate-300 space-y-2">
          <li>• Dimenzionisanje napajanja i zaštite</li>
          <li>• Šemiranje i obeležavanje razvodnih tabli i ormara</li>
      ...
      <div className="grid gap-6 md:grid-cols-[1.2fr,0.8fr]">
        <div className="panel rounded-2xl p-6 border border-slate-800/70 space-y-3">
          <h4 className="text-lg font-semibold">Usluge korišćene na projektu</h4>
          <ul className="text-sm text-slate-300 space-y-2">
