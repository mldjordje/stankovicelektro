...
export default function NotFound() {
  return (
    <div className="mx-auto max-w-xl px-4 md:px-6 py-16 text-center space-y-4">
      <h1 className="text-4xl font-semibold">Stranica nije pronađena</h1>
      <p className="text-slate-300">
        Link je možda promenjen ili više ne postoji. Vratite se na početnu ili kontaktirajte naš tim.
      </p>
